...
# Generated by qmake (2.01a) (Qt 4.8.1) on: la marraskuuta 1 18:47:45 2014
# Project:  millenniumcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug CONFIG+=declarative_debug USE_UPNP=- -o Makefile millenniumcoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_IPV6 -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -g -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -fpermissive -fstack-protector-all --param ssp-buffer-size=1 -g -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/niklas/qt/Millenniumcoin/src/leveldb/libleveldb.a /home/niklas/qt/Millenniumcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -levent -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: millenniumcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug CONFIG+=declarative_debug USE_UPNP=- -o Makefile millenniumcoin-qt.pro
...
/home/niklas/qt/Millenniumcoin/src/leveldb/libleveldb.a: FORCE
	cd /home/niklas/qt/Millenniumcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/niklas/qt/Millenniumcoin/build/build.h: FORCE
	cd /home/niklas/qt/Millenniumcoin; /bin/sh share/genbuild.sh /home/niklas/qt/Millenniumcoin/build/build.h
